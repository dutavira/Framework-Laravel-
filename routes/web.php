...
| contains the "web" middleware group. New create something great!
|
*/
...
Route::get('/pzn', function (){
    return "Hello Programmer Zaman Old";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function (){
    return "404 by Programmer Zaman Old";
});

Route::view('/hello', 'hello', ['name' => 'Duta']);

Route::get('/hello-again', function (){
    return view('hello', ['name' => 'Duta']);
});

Route::get('/hello-world', function (){
    return view('hello.world', ['name' => 'Duta']);
});
...
Route::get('/conflict/Duta', function (){
    return "Conflict Duta Vira";
});
...
//    return route('redirect-hello', ['name' => 'Duta']);
//    return url()->route('redirect-hello', ['name' => 'Duta']);
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Duta']);
});
