...
class RoutingTest extends TestCase
{
    public function testGet()
    {
        $this->get('/pzn')
            ->assertStatus(200)
            ->assertSeeText('Hello Programmer Zaman Old');
    }
    ...
    {
        $this->get('/tidakada')
            ->assertSeeText('404 by Programmer Zaman Old');
    ...
    {
        $this->get('/conflict/agus')
            ->assertSeeText("Conflict agus");

        $this->get('/conflict/duta')
            ->assertSeeText("Conflict Duta Vira");
    }
